        ...
        return (
            <div className={("theme-") + (this.state.isLightTheme ? "light" : "dark")}>
                ...
                <div className="padding-bottom-50">
                    <div className="telegram-page text-center" style={{paddingBottom:"20px"}}>
                        <div className="header-telegram">
                            Connect 
                            <img src={TelegramLogo} className="telegram-logo-tg "/>
                            Telegram
                        </div>
                        ...
                        <div>
                            Go to : <a className="tg-link" href="https://t.me/HodlInfoBot?startgroup=true">https://t.me/HodlInfoBot?startgroup=true</a>
                        </div>
                        <br/>
                        <div className="header-telegram-heading">
                            Chat with the bot
                        ...
                        <div className="sub-heading-telegram"><br/>Automatic :</div>
                        <div>
                            Go to : <a className="tg-link" href="https://t.me/HodlInfoBot">https://t.me/HodlInfoBot</a>
                        </div>
